...
/**
 * This setting controls whether OpenGL for harmonyOS should be included.
 *
 * Default: 0 (or detected by configure)
 */
#ifndef PJMEDIA_VIDEO_DEV_HAS_OHOS_OPENGL
#  define PJMEDIA_VIDEO_DEV_HAS_OHOS_OPENGL  0
#else
#  if defined(PJMEDIA_VIDEO_DEV_HAS_OHOS_OPENGL) && \
              PJMEDIA_VIDEO_DEV_HAS_OHOS_OPENGL != 0
#    undef  PJMEDIA_VIDEO_DEV_HAS_OPENGL_ES
#    define PJMEDIA_VIDEO_DEV_HAS_OPENGL_ES     1
#    define PJ_OHOS     1
#  endif
...
/**
 * this setting ohos vido controls
*/
#ifndef PJMEDIA_VIDEO_DEV_HAS_OHOS
